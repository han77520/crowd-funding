...
import com.whw.crowd.config.PayProperties;
...
public class PayController {
    ...
    public String generateOrder(HttpSession session, OrderVO orderVO) throws AlipayApiException {
        ...
        Double orderAmount = (double) (orderProjectVO.getSignalPurchase() * orderProjectVO.getReturnCount() + orderProjectVO.getFreight());
